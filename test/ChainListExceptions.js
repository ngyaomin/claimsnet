...
contract('ChainList', function(accounts) {
  ...
  // test case:  buying when no article for sale
  it("should throw exception if you try to buy when nothing for sale", function() {
    ...
    .catch(function(error) {
      ...
      // make sure state of contract is not altered
